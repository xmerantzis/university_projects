...
* {
  box-sizing: border-box;
		...
		<body>
			...
			<div>
				<input type="password" class="form-control" name="repeat_pass" placeholder="Retype Password" required>
			</div>

			<button type="submit" name="reg_user" onclick = "register_user()" >Καταχώριση</button>
